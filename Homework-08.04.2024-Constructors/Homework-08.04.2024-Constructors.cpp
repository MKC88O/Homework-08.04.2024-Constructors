// Homework-08.04.2024-Constructors.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
    ...
    PowerBank PB2(30000, "Black");
    PB2.Charging();
    PB2.PowerBankInfo();

    PowerBank PB3("Brand", 35000);
    PB3.Charging();
    PB3.PowerBankInfo();

    PowerBank PB4("Brand", "Green", 40000);
    PB4.Charging();
    PB4.PowerBankInfo();

    PowerBank PB5("Brand", "Red");
    PB5.Charging();
    PB5.PowerBankInfo();
